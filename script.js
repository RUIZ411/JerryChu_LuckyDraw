...
function applyBroadcastPulse(pulse){
  ...
  broadcastResultTimer=setTimeout(()=>closeModal("resultModal"),1600);
}
...
preloadSoundEffects();if(IS_BROADCAST_VIEW){initializeBroadcastView()}else{renderAll();restartPolling();setTimeout(()=>scheduleBroadcastPublish(true),700)}
