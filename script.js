...
function showBatchResultSummary(result){
  ...
  if(IS_BROADCAST_VIEW){
    broadcastResultTimer=setTimeout(()=>closeModal("batchResultModal"),10000);
  }
  return true;
}
